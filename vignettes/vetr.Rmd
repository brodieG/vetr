...
better than using `stopifnot`.  Here we run our checks on valid iris objects
we used to illustrate [declarative checks](#declarative-checks-with-templates):
...
if(require(valaddin)) {
  ...
  secant_valaddin <- function(...) stop("valaddin not available")
}
