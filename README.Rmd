...
[![Dependencies direct/recursive](https://tinyverse.netlify.com/badge/vetr)](https://tinyverse.netlify.com/)
...
(Travis build status: [![](https://travis-ci.org/brodieG/vetr.svg?branch=development)](https://travis-ci.org/brodieG/vetr)).  The master branch typically mirrors CRAN and should be stable.
