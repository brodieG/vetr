...
Checking vector values in a long vector:
```{r}
...
`assertive` is substantially slower, likely because it applies an R function
call to each element, so we benchmark it separately:
